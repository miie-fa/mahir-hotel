...
<body>
        ...
        <div class="row mb-4 my-5 mt-5 position-relative">
            ...
            <div class="col-md-6">
                <div class="paragraph p-3 overlap-paragraph">
                    ...
                    <p>Lokasi yang strategis merupakan salah satu <br>keunggulan utama. Terletak di pusat kota, Anda akan <br>menemukan diri Anda dikelilingi oleh kehidupan perkotaan  <br>yang dinamis. Hanya beberapa langkah dari hotel, Anda <br>dapat menjelajahi atraksi lokal,mengeksplorasi tempat-tempat <br> wisata populer dan menikmati kehidupan malam yang berwarna.</p>
                </div>
            </div>
        </div>
        <div class="row mb-4 my-5 mt-5 position-relative">
    ...
    <section class="section9 my-5">
        ...
        <div class="row justify-content-center d-flex">
            ...
            <a href="" class="btn">
                <i class="fa fa-utensils"></i> Resturant
            </a>
