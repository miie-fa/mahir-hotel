    ...
    <span class="roomlistgroup">
        <section class="roomdetail">
            <div class="card mb-3" style="max-width: 900px">
                <div class="row g-0">
                    <div class="col-md-12">
                        <img src="{{ asset('assets/superior.jpg') }}" class="img-fluid" alt="..." />
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <p>Nikmati kenyamanan superior di kamar Superior kami. Desain interior yang elegan dan mewah
                                menciptakan suasana yang sempurna untuk melepas penat setelah hari yang panjang. kamar
                                luad dengan area tidur dan tempat duduk yang terpisah memberikan privasi dan ruang yang
                                lapang</p>
