    ...
    <span class="roomlistgroup">
        <section class="roomdetail">
            <div class="card mb-3" style="max-width: 900px">
                <div class="row g-0">
                    <div class="col-md-12">
                        <img src="{{asset('assets/single.jpg')}}" class="img-fluid" alt="Single Room">
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                            <div class="flex-b">
                            ...
                            <p>Rasakan kenyamanan di kamar Single kami. Cocok untuk wisatawan tunggal atau pasangan, kamar ini menawarkan tempat tidur yang nyaman dan fasilitas modern untuk memastikan Anda memiliki masa menginap yang menyenangkan.</p>
        ...
        <section class="orderdetail">
            <div class="card border-secondary mb-3" style="max-width: 28.5rem;">
                ...
                <div class="card-body text-secondary">
                    ...
                    <div class="underlined-text">Single Room</div>
                    <div class="flex-a">
                        <p>1 malam</p>
                        <h6>Rp 350.000</h6>
                    </div>
